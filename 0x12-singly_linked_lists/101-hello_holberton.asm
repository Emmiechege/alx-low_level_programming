...
main:
	...
	lea rdi, [txt]
	; load(lea - command to load) ddress of txt strng to rdi
	; rdi(register destination index) - destination for data copies
	xor eax, eax
	; clear eax register
	; xor - Between eax register and itself (XOR - Bitwise operator)
